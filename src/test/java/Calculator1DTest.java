...
public class Calculator1DTest {
  ...
  public void testCalcNewSolution_ExistingSolution() {
    ...
    assertEquals(calcSolution1.getShotRotations(), 10);
  }
  ...
  public void testCalcNewSolution_OutsideBounds() {
    ...
    assertEquals(calcSolution2.getShotRotations(), 50);
  }
  ...
  public void testAddNewSolution_NewCalculation() {
    ...
    assertEquals(calcSolution1.getShotRotations(), 35);
    ...
    assertEquals(calcSolution2.getShotRotations(), 30);
  }
